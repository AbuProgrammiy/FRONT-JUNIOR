...
{
    public class SendVerificationToRegisterCommandHandler : IRequestHandler<SendVerificationToRegisterCommand, ResponseModel>
    {
        private readonly IApplicationDbContext _applicationDbContext;
        private readonly ISendEmailService _sendEmailService;
        private readonly IWebHostEnvironment _webHostEnvironment;

        public SendVerificationToRegisterCommandHandler(IApplicationDbContext applicationDbContext, ISendEmailService sendEmailService, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<ResponseModel> Handle(SendVerificationToRegisterCommand request, CancellationToken cancellationToken)
        {
            try
            {
